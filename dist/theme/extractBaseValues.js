...
export const extractBaseValues = (token) => {
    ...
    root.walkRules((rule) => {
        rule.walkDecls((decl) => {
            if (decl.prop.includes(cleanedToken) ||
...
export const getExtractedContent = (cleanedToken, theme) => {
...
export const getModeToken = (token, theme) => {
